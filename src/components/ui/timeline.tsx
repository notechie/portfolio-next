    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
            ...
            className="hidden lg:block h-full absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
